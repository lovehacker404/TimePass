...
"""+Y+"""["""+C+"""AUTHOR """+Y+"""]"""+G+""" BlackMafia
"""+Y+"""["""+C+""" TEAM  """+Y+"""]"""+G+""" BlackMafia Team
"""+Y+"""["""+C+"""VERSION"""+Y+"""]"""+G+""" 1.0
"""+Y+"""["""+C+"""THANKS """+Y+"""]"""+G+"""BlackMafia"""
...
def menu():
	...
	print logo
	print
	print R+"[1].Compile Marshal"
	print R+"[2].Compile Base64"
	print R+"[3].Compile Marshal ==> Base64"
	print R+"[0].Exit"
	print
